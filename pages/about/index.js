  ...
  return <div className="text-center xl:text-left py-0 xl:py-20 h-full relative">
    ...
    <div className="container h-full mx-auto px-5 flex flex-col xl:items-start items-center xl:flex-row xl:gap-x-10 gap-x-4">
      <div className="flex flex-col justify-center h-[300px] xl:mt-10">
        ...
        <motion.form method="get" action="/phamtrithinh_0702895474_frontenddeveloper.pdf" className="xl:justify-start gap-x-5 justify-center flex" variants={fadeIn('down', 0.4)} initial="hidden" animate="show" exit="hidden">
      ...
      <div className='flex flex-col w-full xl:max-w-[48%] h-[calc(100%-300px)] xl:h-full'>
        ...
        <motion.div variants={fadeIn('down', 0.6)} initial="hidden" animate="show" exit="hidden" className='h-[calc(100%-60px)] overflow-y-auto'>
