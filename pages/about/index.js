...
const About = () => {
  ...
  return <>
    ...
    />
    <div className="text-center xl:text-left  h-full relative">
      <div className="container h-full mx-auto px-5 flex flex-col items-center xl:flex-row xl:gap-x-10 gap-x-4">
        ...
        <div className='flex flex-col w-full xl:max-w-[48%] flex-1'>
          ...
          <motion.div variants={fadeIn('down', 0.6)} initial="hidden" animate="show" exit="hidden" className='xl:h-full h-[calc(100dvh-550px)] overflow-y-auto'>
