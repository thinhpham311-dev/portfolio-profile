    ...
    useEffect(() => {
        const handleFullscreenChange = () => {
            ...
            if (inFullscreen) {
                ...
                const storedDarkMode = localStorage.getItem('projectDarkMode') === 'true'
    ...
    return (
        <>
            ...
            <motion.div
                ...
                className={`shadow-xl overflow-auto z-40 relative flex flex-col justify-between
          ${isFullscreen
            ...
            >
                <div className='flex flex-col'>
                    ...
                    <div className="space-y-4 text-base leading-relaxed px-4 h-full">
                        {project?.description ? (
                            ...
                            <div className="p-5">
                                <p className="text-center">Content will be available soon.</p>
                            </div>
                        )}
                    </div>
                </div>
                ...
                {(previousProject || nextProject) && (
                    <div className="flex justify-between items-center border-t mt-10 py-3">
                        {previousProject ? (
                            <Link
                                href={`/project/${previousProject.slug}`}
                                className="text-sm text-white-700 hover:underline flex items-center space-x-1"
                            >
