...
const ProjectsBtn = () => {
  return <div className="mx-auto xl:mx-0">
    <Link href="/project" className="relative xl:w-[185px] xl:h-[185px] w-[150px] h-[150px] flex items-center justify-center bg-circleStar bg-cover bg-center bg-no-repeat group">
